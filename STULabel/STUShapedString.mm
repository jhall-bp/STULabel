...
STU_EXPORT
NSWritingDirection
stu_detectBaseWritingDirection(NSString *__unsafe_unretained nsString, NSRange range, bool skipIsolatedText)
{
  if (!nsString)
...
STU_EXPORT
size_t STUShapedStringGetLength(STUShapedString *self) { return sign_cast(self->shapedString->stringLength); }
    ...
    NS_RETURNS_RETAINED
{
  ...
  Byte *p;
  ShapedString *const shapedString =
      ShapedString::create(attributedString, baseWritingDirection, cancellationFlag, [&](UInt size) -> void * {
...
STU_NO_INLINE
Unretained<STUShapedString * __nonnull> stu_label::emptyShapedString(STUWritingDirection baseWritingDirection)
{
  switch (clampBaseWritingDirection(baseWritingDirection)) {
  case STUWritingDirectionLeftToRight: {
    STU_STATIC_CONST_ONCE(
        STUShapedString *,
        emptyLTRShapedString,
        STUShapedStringCreate(nil, stu_emptyAttributedString(), STUWritingDirectionLeftToRight, nullptr));
    return emptyLTRShapedString;
  }
  case STUWritingDirectionRightToLeft: {
    STU_STATIC_CONST_ONCE(
        STUShapedString *,
        emptyRTLShapedString,
        STUShapedStringCreate(nil, stu_emptyAttributedString(), STUWritingDirectionRightToLeft, nullptr));
