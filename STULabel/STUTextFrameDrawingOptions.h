...
NS_SWIFT_NAME(STUTextFrame.DrawingOptions) STU_EXPORT @interface STUTextFrameDrawingOptions : NSObject<NSCopying>
...
- (void)setHighlightTextFrameRange:(STUTextFrameRange)textFrameRange NS_REFINED_FOR_SWIFT
    NS_SWIFT_NAME(__setHighlightRange(_:));
// public func setHighlightRange(_ textFrameRange: Range<STUTextFrame.Index>)

- (bool)getHighlightTextFrameRange:(nullable STUTextFrameRange *)outTextFrameRange NS_REFINED_FOR_SWIFT
    NS_SWIFT_NAME(__getHighlightTextFrameRange(_:));
