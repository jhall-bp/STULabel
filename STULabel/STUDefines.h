...
#define STU_UNAVAILABLE(messageString) __attribute__((__unavailable__(messageString)));

#define STU_SWIFT_UNAVAILABLE __attribute__((__availability__(swift, unavailable)))
...
#define STU_ASSUME_NONNULL_AND_STRONG_BEGIN                                                                            \
  _Pragma("clang assume_nonnull begin") STU_DISABLE_CLANG_WARNING("-Wobjc-property-no-attribute")
