...
STU_NO_INLINE STU_NO_RETURN void TextFrameDrawingOptions::attemptedMutationOfFrozenObject()
{
...
- (STUTextHighlightStyle *)highlightStyle
{
  return impl.highlightStyle().unretained;
}
