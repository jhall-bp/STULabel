...
- (nonnull STUTextFrame *)textFrame
{
  return _textFrame;
}
...
{
  return _contextBaseCTM_d;
}
- (bool)pixelAlignBaselines
{
  return _pixelAlignBaselines;
}
- (STUTextFrameDrawingOptions *)options
{
  return _options;
}
- (nullable const STUCancellationFlag *)cancellationFlag
{
...
STULabelDrawingBlockParameters *__nonnull stu_label::createLabelDrawingBlockParametersInstance(
...
- (void)draw
{
  drawTextFrame(_textFrame,
                _range,
                _textFrameOrigin,
                _context,
                ContextBaseCTM_d{_contextBaseCTM_d},
                PixelAlignBaselines{_pixelAlignBaselines},
                _options,
                _cancellationToken);
}

STU_EXPORT
STUTextFrameWithOrigin STULabelDrawingBlockParametersGetTextFrameWithOrigin(STULabelDrawingBlockParameters *self)
{
