...
STUTextFrameWithOrigin STULabelLayerGetTextFrameWithOrigin(STULabelLayer *labelLayer) NS_REFINED_FOR_SWIFT;

STUTextFrameWithOrigin
STULabelDrawingBlockParametersGetTextFrameWithOrigin(STULabelDrawingBlockParameters *params) NS_REFINED_FOR_SWIFT;
