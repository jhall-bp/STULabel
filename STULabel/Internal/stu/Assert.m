...
#define handleFailure(fileName, line, functionName, format, ...)                                                       \
  [[NSAssertionHandler currentHandler]                                                                                 \
      handleFailureInFunction:(functionName ? [NSString stringWithUTF8String:functionName] : @"<Unknown Function>")    \
                         file:(fileName ? [NSString stringWithUTF8String:fileName] : @"<Unknown File>")lineNumber:line \
...
extern "C"
    ...
    stu_assertion_failed(const char *fileName, int line, const char *functionName, const char *condition)
{
#if STU_DEBUG
