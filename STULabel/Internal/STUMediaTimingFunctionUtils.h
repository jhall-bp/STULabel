...
STU_INLINE bool stu_CAMediaTimingFunctionEqualToFunction(CAMediaTimingFunction *__nullable a,
                                                         CAMediaTimingFunction *__nullable b)
{
  if (a == b)
    return true;
  if (!a || !b)
  ...
  return cas.c1x == cbs.c1x && cas.c1y == cbs.c1y && cas.c2x == cbs.c2x && cas.c2y == cbs.c2y;
}
