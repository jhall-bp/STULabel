  ...
  dispatch_once_f(&once, nullptr, [](void *) {
    ...
    appLocalization =
        [[NSBundle preferredLocalizationsFromArray:localizations
                                    forPreferences:NSBundle.mainBundle.preferredLocalizations] firstObject]
            ?: @"en";
    systemLocalization = [[NSBundle preferredLocalizationsFromArray:localizations
                                                     forPreferences:NSLocale.preferredLanguages] firstObject]
                             ?: @"en";
    localizedStrings_app = [[NSDictionary alloc] initWithContentsOfFile:[bundle pathForResource:@"Localizable"
                                                                                         ofType:@"strings"
                                                                                    inDirectory:nil
                                                                                forLocalization:appLocalization]];
    localizedStrings_system = [[NSDictionary alloc] initWithContentsOfFile:[bundle pathForResource:@"Localizable"
                                                                                            ofType:@"strings"
                                                                                       inDirectory:nil
                                                                                   forLocalization:systemLocalization]];
    STU_CHECK_MSG(localizedStrings_app && localizedStrings_system, "Failed to load STULabel strings dictionary");
  });
}
