...
class TapToReadMoreVC: UIViewController, STULabelDelegate {
  ...
  override func viewDidLoad() {
    ...
    let string2LTR =
      "This also works when the truncated line happens to contain right-to-left text:\n"
    let string2RTL =
      "هذا مجرد نص حشو عربي ممل يجب أن يمتد على أكثر من سطر واحد ويفضل أن يكون أكثر من سطرين ، أو حتى أكثر من ثلاثة أسطر. "
