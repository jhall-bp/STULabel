...
static RC<CGPath> createMutableCGPath() { return {CGPathCreateMutable(), ShouldIncrementRefCount{false}}; }
...
UIImage *createImage(CGSize size,
                     ...
                     FunctionRef<void(CGContext *)> closure)
{
  const auto options = backgroundColor ? STUCGImageFormatWithoutAlphaChannel : STUCGImageFormatOptionsNone;
  auto cgImage = stu_createCGImage(
      size, scale, backgroundColor.CGColor, stuCGImageFormat(format, options), ^(CGContextRef context) {
        closure(context);
      });
  const auto image = [[UIImage alloc] initWithCGImage:cgImage scale:scale orientation:UIImageOrientationUp];
  CFRelease(cgImage);
  return image;
}
                                  ...
                                  AddLineSpansPathArgs args)
{
  ...
  const CGSize size = {rect.origin.x + rect.size.width, rect.origin.y + rect.size.height};

  return createImage(size, 1, UIColor.whiteColor, STUPredefinedCGImageFormatGrayscale, [&](CGContextRef context) {
...
Vector<TextLineSpan> createSpansForStars(CGFloat nonStarWidth, CGFloat starWidth, const char *const string)
{
  ...
  for (Int i = 0; i < length; ++i) {
    ...
    if (c != '*' && c != '\n') {
      ...
      vector.append(TextLineSpan{
          .x = range(xStart, x), .lineIndex = lineIndex, .isLeftEndOfLine = vector.count() == lineStartSpanIndex});
    } else { // c == '\n'
      lineIndex += 1;
      x = 0;
...
- (void)assertLinearCGPath:(CGPath &)path equals:(ArrayRef<const ArrayRef<const CGPoint>>)expectedSubpaths
{
...
- (void)testAddLineSpansPathWithSimpleLinearPaths
{
  ...
  }
  {
    auto path = createPathWithSpans(
        {{.x = {1, 3}, .lineIndex = 0}}, vs, {.clipRect = SRect{range(0, 1.1f), range(0, t(0) + 0.1f)}});
    [self assertLinearCGPath:*path equals:{{{1, t(0)}, {3, t(0)}, {3, b(0)}, {1, b(0)}}}];
  }
  {
    auto path =
        createPathWithSpans({{.x = {1, 3}, .lineIndex = 0}}, vs, {.clipRect = SRect{range(0, 1.f), range(0, t(0))}});
    [self assertLinearCGPath:*path equals:{}];
  }
  {
    auto path = createPathWithSpans({{.x = {1, 3}, .lineIndex = 0}, {.x = {4, 5}, .lineIndex = 0}}, vs);
    [self assertLinearCGPath:*path
                      equals:{{{1, t(0)}, {3, t(0)}, {3, b(0)}, {1, b(0)}},
                              {{4, t(0)}, {5, t(0)}, {5, b(0)}, {4, b(0)}}}];
  }
  {
    auto path = createPathWithSpans({{.x = {1, 3}, .lineIndex = 0}, {.x = {4, 5}, .lineIndex = 0}},
                                    vs,
                                    {.clipRect = SRect{Range{4, 6.f}, Range{t(0), b(0)}}});
    [self assertLinearCGPath:*path equals:{{{4, t(0)}, {5, t(0)}, {5, b(0)}, {4, b(0)}}}];
  }
  {
    auto path = createPathWithSpans({{.x = {1, 3}, .lineIndex = 0}}, vs, {.edgeInsets = UIEdgeInsets{.left = -0.5}});
    [self assertLinearCGPath:*path equals:{{{0.5, t(0)}, {3, t(0)}, {3, b(0)}, {0.5, b(0)}}}];
  }
  {
    auto path = createPathWithSpans({{.x = {1, 3}, .lineIndex = 0}}, vs, {.edgeInsets = UIEdgeInsets{.right = -0.5}});
    [self assertLinearCGPath:*path equals:{{{1, t(0)}, {3.5, t(0)}, {3.5, b(0)}, {1, b(0)}}}];
  }
  {
    auto path = createPathWithSpans({{.x = {1, 3}, .lineIndex = 0}, {.x = {1, 3}, .lineIndex = 1}}, vs);
    [self assertLinearCGPath:*path
                      equals:{{{1, t(0)}, {3, t(0)}, {3, b(0)}, {1, b(0)}},
  ...
  {
    auto path = createPathWithSpans(
        {{.x = {1, 3}, .lineIndex = 0}, {.x = {1, 3}, .lineIndex = 1}}, vs, {.fillTextLineGaps = true});
    [self assertLinearCGPath:*path equals:{{{3, t(0)}, {3, b(1)}, {1, b(1)}, {1, t(0)}}}];
  }
  {
    auto path =
        createPathWithSpans({{.x = {1, 3}, .lineIndex = 0, .isLeftEndOfLine = true, .isRightEndOfLine = true},
                             {.x = {1.5, 2.5}, .lineIndex = 1, .isLeftEndOfLine = true, .isRightEndOfLine = true}},
                            vs,
                            {.fillTextLineGaps = true, .shouldExtendToCommonBounds = true});
    [self assertLinearCGPath:*path equals:{{{3, t(0)}, {3, b(1)}, {1, b(1)}, {1, t(0)}}}];
  }
  {
    auto path = createPathWithSpans(
        {{.x = {-1, 0}, .lineIndex = 0}, {.x = {1, 3}, .lineIndex = 0}, {.x = {1, 3}, .lineIndex = 1}},
        vs,
        {.fillTextLineGaps = true});
    [self assertLinearCGPath:*path
                      equals:{{{0, t(0)}, {0, b(0)}, {-1, b(0)}, {-1, t(0)}},
  ...
  }
  {
    auto path = createPathWithSpans({{.x = {1, 3}, .lineIndex = 0},
                                    ...
                                    {.fillTextLineGaps = true});
    [self assertLinearCGPath:*path
                      equals:{{{3, t(0)}, {3, t(1)}, {4, t(1)}, {4, b(1)}, {2, b(1)}, {2, b(0)}, {1, b(0)}, {1, t(0)}},
  ...
  }
  {
    auto path = createPathWithSpans({{.x = {2, 4}, .lineIndex = 0},
                                    ...
                                    {.fillTextLineGaps = true});
    [self assertLinearCGPath:*path
                      equals:{{{4, t(0)}, {4, b(0)}, {3, b(0)}, {3, b(1)}, {1, b(1)}, {1, t(1)}, {2, t(1)}, {2, t(0)}},
                              {{5, t(1)}, {5, b(1)}, {4, b(1)}, {4, t(1)}},
                              {{2, t(3)}, {4, t(3)}, {4, b(3)}, {2, b(3)}}}];
  }
  {
    auto path = createPathWithSpans({{.x = {0, 5}, .lineIndex = 0},
                                     {.x = {0, 1}, .lineIndex = 1},
                                     {.x = {4, 5}, .lineIndex = 1},
                                     {.x = {0, 1}, .lineIndex = 2},
                                     {.x = {2, 3}, .lineIndex = 2},
                                    ...
                                    {.fillTextLineGaps = true});
    [self assertLinearCGPath:*path
                      equals:{{{5, t(0)}, {5, b(4)}, {0, b(4)}, {0, t(0)}},
...
- (void)testAddLineSpansPath
{
  ...
  const auto createImageForStars = [&](const CGFloat nonStarWidth,
                                       const CGFloat starWidth,
                                       AddLineSpansPathArgs args,
  ...
  CHECK_SNAPSHOT_IMAGE(createImageForStars(10, 10, {.fillTextLineGaps = true}, str1), @"_1");
  CHECK_SNAPSHOT_IMAGE(createImageForStars(10, 10, {.fillTextLineGaps = true, .cornerRadius = 100}, str1),
                       @"_1_rounded");
  CHECK_SNAPSHOT_IMAGE(
      createImageForStars(
          10,
          10,
          {.fillTextLineGaps = true, .cornerRadius = 100, .transform = CGAffineTransformMakeTranslation(15, 15)},
          str1),
      @"_1_rounded_shifted");

  CHECK_SNAPSHOT_IMAGE(
      createImageForStars(
          10, 10, {.fillTextLineGaps = true, .edgeInsets = UIEdgeInsets{2, 2, 2, 2}, .cornerRadius = 100}, str1),
      @"_1_rounded_inset_2"
  ...
  CHECK_SNAPSHOT_IMAGE(
      createImageForStars(
          10, 10, {.fillTextLineGaps = true, .edgeInsets = UIEdgeInsets{5, 5, 5, 5}, .cornerRadius = 100}, str1),
      @"_1_rounded_inset_5");
  CHECK_SNAPSHOT_IMAGE(
      createImageForStars(
          10,
          10,
          {.fillTextLineGaps = true, .edgeInsets = UIEdgeInsets{.top = 5, .bottom = 5}, .cornerRadius = 100},
          str1),
      @"_1_rounded_inset_v5");
  CHECK_SNAPSHOT_IMAGE(
      createImageForStars(
          10,
          10,
          {.fillTextLineGaps = true, .edgeInsets = UIEdgeInsets{.left = 5, .right = 5}, .cornerRadius = 100},
          str1),
      @"_1_rounded_inset_h5");
  CHECK_SNAPSHOT_IMAGE(
      createImageForStars(
          10, 10, {.fillTextLineGaps = true, .edgeInsets = UIEdgeInsets{20, 20, 20, 20}, .cornerRadius = 100}, str1),
      @"_1_rounded_inset_20");
  ...
  CHECK_SNAPSHOT_IMAGE(
      createImageForStars(
          10,
          10,
          {.fillTextLineGaps = true, .edgeInsets = UIEdgeInsets{-20, -20, -20, -20}, .cornerRadius = 100},
          str1),
