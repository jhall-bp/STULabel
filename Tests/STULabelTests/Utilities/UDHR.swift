...
class UDHR {
  ...
  final class Translation {
      ...
      -> NSAttributedString
    {
      ...
      str.append(NSAttributedString(string: self.title + nl, attributes: titleAttributes))
      for article in self.articles {
        str.append(NSAttributedString(string: nl + article.title + nl, attributes: titleAttributes))
        for paragraph in article.paragraphs {
          str.append(NSAttributedString(string: paragraph + nl, attributes: bodyAttributes))
        }
      }
