...
public func constrain(
  _ constraints: inout [NSLayoutConstraint],
...
func constrain(
  ...
  constraints.ensureFreeCapacity(
    items.count
      + (container == nil
        ? -1
...
{
  return constrain(
    attribute1.anchor(item1), relation, attribute2.anchor(item2),
...
{
  return constrain(
    attribute2.anchor(item1), relation, attribute2.anchor(item2),
    plus: offset, priority: priority)
}
...
{
  return constrain(
    attribute1.anchor(item1), relation, item2, attribute2,
...
{
  return constrain(
    attribute.anchor(item), relation, positionAbove: label, baseline,
...
{
  return constrain(
    attribute.anchor(item), relation, positionBelow: label, baseline,
    spacingMultipliedBy: spacingMultiplier, plus: offset, priority: priority)
}
...
public func constrain(
  ...
  constraints.append(
    constrain(
      item1, attribute1, relation, item2, attribute2,
      plus: offset, priority: priority))
}
