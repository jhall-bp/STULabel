...
struct DynamicTypeFontScalingTests {
  ...
  func `adjusted font respects the content size category`() {
    ...
    #expect(fixedFont == fixedFont.stu_fontAdjusted(forContentSizeCategory:
    ...
    #expect(italicPreferredFont.stu_fontAdjusted(forContentSizeCategory: .extraSmall) ==
    ...
    #expect(label.font == scaledPreferredFont.stu_fontAdjusted(forContentSizeCategory: .large)
    ...
    #expect(label.font == scaledHelvetica.stu_fontAdjusted(forContentSizeCategory: .extraExtraLarge))
    #expect(label.font == scaledHelvetica.stu_fontAdjusted(forContentSizeCategory: .extraExtraLarge))
    ...
    #expect(label.font == scaledHelvetica2.stu_fontAdjusted(forContentSizeCategory: .extraExtraExtraLarge))
    #expect(label.font == scaledHelvetica2.stu_fontAdjusted(forContentSizeCategory: .extraExtraExtraLarge))
  ...
  func `attributed string fonts respect the content size category`() {
    ...
    #expect(NSAttributedString(string: "Test", attributes: [.font: font1])
    ...
    #expect((string.attributes(at: 4, effectiveRange: nil) as NSObject).isEqual(
