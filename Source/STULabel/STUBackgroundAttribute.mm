...
#define FOR_ALL_FIELDS(f)                                                                                              \
  f(UIColor *, color) f(bool, fillTextLineGaps) f(bool, extendTextLinesToCommonHorizontalBounds)                       \
      f(CGFloat, cornerRadius) f(UIEdgeInsets, edgeInsets) f(UIColor *, borderColor) f(CGFloat, borderWidth)           \
...
- (BOOL)isEqual:(id)object
{
  ...
  if (![object isKindOfClass:stuBackgroundAttributeClass])
    return false;
