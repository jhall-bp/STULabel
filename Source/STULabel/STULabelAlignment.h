...
enum
{
  STULabelHorizontalAlignmentBitSize STU_SWIFT_UNAVAILABLE = 2
};
...
enum
{
  STULabelVerticalAlignmentBitSize STU_SWIFT_UNAVAILABLE = 3
};
...
enum
{
  STULabelDefaultTextAlignmentBitSize STU_SWIFT_UNAVAILABLE = 2
};
