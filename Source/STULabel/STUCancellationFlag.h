...
static STU_INLINE void STUCancellationFlagSetCancelled(STUCancellationFlag *token) {
...
static STU_INLINE __attribute__((warn_unused_result)) bool
STUCancellationFlagGetValue(const STUCancellationFlag *token) {
